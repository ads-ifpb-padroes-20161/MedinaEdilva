<%-- 
    ...
    Created on : 25/08/2016, 14:58:21
    Author     : Edilva
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container" style="width:60%">
            <div class="row">
                <form method="post" id="cadastroMedico" action="Controller?command=CadastrarMedico" name="formMedico">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <select class="form-control" name="cnpj" id="clinica">
